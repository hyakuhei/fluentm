from fluentm import Actor, Boundary, Process, Data, DataFlow, HTTP, TLS
...
scenes = {
    ...
    "Customer buys book":[ 
        ...
        DataFlow(Process("Web Server"), Process("Merchant API").inBoundary(Boundary("Visa")), "Process payment", response=TLS(HTTP("Confirmation"))), # Dynamic creation of merchant in this flow - not modelled above.
...
if __name__ == "__main__":
    report(scenes, outputDir="examples/tiaga")
